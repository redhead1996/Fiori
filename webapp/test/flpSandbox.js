		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice List",
									"targetURL": "#invoicelistinvoice01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicelistinvoice01-display": {
								"semanticObject": "invoicelistinvoice01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoicelist.invoice01",
									"url": sap.ui.require.toUrl("invoicelist/invoice01")
								}
							}
						}
					}
